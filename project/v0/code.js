define(["exports", "libraries/beyond_bundles/processors/css/js.js", "react", "react-dom"], function (_exports, _js, _react, _reactDom) {
  "use strict";

  Object.defineProperty(_exports, "__esModule", {
    value: true
  });
  _exports.JidaCalendarContextProvider = JidaCalendarContextProvider;
  _exports.JidaCalendar = JidaCalendar;
  _exports.calendarFactory = calendarFactory;
  _exports.JCalendar = _exports.useJidaCalendarContext = _exports.JidaCalendarContext = void 0;
  ...
  **********/
  ...
  const JidaCalendarContext = _react.default.createContext();

  _exports.JidaCalendarContext = JidaCalendarContext;

  function JidaCalendarContextProvider({
    calendar,
    children
  }) {
    ...
    const [view, setView] = _react.default.useState(calendar.view);
    ...
    return /*#__PURE__*/_react.default.createElement(JidaCalendarContext.Provider, {
      value: value
    }, /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement("button", {
      "data-view": "MONTH",
      onClick: changeView
    }, "Mes"), /*#__PURE__*/_react.default.createElement("button", {
      "data-view": "WEEK",
      onClick: changeView
    }, "Semana"), /*#__PURE__*/_react.default.createElement(Control, null)));
  }

  const useJidaCalendarContext = () => _react.default.useContext(JidaCalendarContext);
  /***********
  calendar.jsx
  ***********/


  _exports.useJidaCalendarContext = useJidaCalendarContext;

  class JCalendar extends _react.default.Component {
    constructor(props) {
      super(props);
    ...
    render() {
      ...
      return /*#__PURE__*/_react.default.createElement(JidaCalendarContextProvider, {
  ...
  *****************/
  ...
  _exports.JCalendar = JCalendar;

  class DayView extends _react.default.Component {
    render() {}
  ...
  *************************/
  ...
  class MonthView extends _react.default.Component {
    ...
    render() {
      ...
      const output = daysNames.map(item => /*#__PURE__*/_react.default.createElement("th", {
        key: `day-${item}`
      }, item));
      const weeks = [];
      month.weeks.items.forEach((week, i) => {
        const output = [];
        week.days.forEach((day, i) => output.push( /*#__PURE__*/_react.default.createElement("td", {
          key: `${day.day}-${i}`
        }, day.day)));
      ...
      return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("h1", null, month.name), /*#__PURE__*/_react.default.createElement("button", {
        "data-action": "prev",
        onClick: changeMonth
      }, `<`), /*#__PURE__*/_react.default.createElement("button", {
        "data-action": "next",
        onClick: changeMonth
      }, `>`), /*#__PURE__*/_react.default.createElement("table", null, /*#__PURE__*/_react.default.createElement("tbody", null, /*#__PURE__*/_react.default.createElement("tr", null, output), weeks)));
    }
  ...
  ******************/
  ...
  class WeekView extends _react.default.Component {
    constructor() {
      super();
      this.state = {};
    ...
    render() {
      ...
      week.days.forEach(day => {
        output.push( /*#__PURE__*/_react.default.createElement("div", {
          key: day.index
        }, /*#__PURE__*/_react.default.createElement("h4", null, day.day, "-", day.name, " - ", day.shortName)));
      });

      const change = event => this.context.calendar.changeWeek(event.currentTarget.dataset.action);

      return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("h3", null, "View ", week.month.name), /*#__PURE__*/_react.default.createElement("button", {
        "data-action": "prev",
        onClick: change
      }, `<`), /*#__PURE__*/_react.default.createElement("button", {
        "data-action": "next",
        onClick: change
      }, `>`), /*#__PURE__*/_react.default.createElement("hr", null), output);
    }
  ...
  ******************/
  ...
  class YearView extends _react.default.Component {
    render() {}
  ...
  ******/
  ...
  function BaseCalendar(parent, specs) {
    ...
    Object.defineProperty(parent, 'format', {
      get: () => specs.format
    });
    Object.defineProperty(parent, 'currentDate', {
      get: () => current
    });
    let day = current.date();
    Object.defineProperty(parent, 'day', {
      'get': () => day
    ...
    this.years = years;
    Object.defineProperty(parent, 'months', {
      get: () => years.active?.months
    });
    Object.defineProperty(parent, 'month', {
      get: () => years.active?.months?.active
    });
    Object.defineProperty(parent, 'year', {
      get: () => year
    });
    Object.defineProperty(parent, 'actualMonth', {
      get: () => month + 1
    });
  ...
  **********/
  ...
  function JidaCalendar(specs = {}) {
    const m1 = 'jc1';
    const m2 = 'jc2';
    const m3 = 'jc3';
    performance.mark(m1); // console.trace("instanciamos calendario...", specs)
    ...
    let dayjs;
    Object.defineProperty(this, 'dayjs', {
      get: () => dayjs
    });
    Object.defineProperty(this, 'daysNames', {
      get: () => Week.getDays()
    });
    window.c = this;
    let initialised;
    ...
    const initialise = async () => {
      ...
      base.triggerEvent('change'); //TODO: remove loaded event if isn't used
  ...
  *****/
  ...
  function Day(calendar, month, week, date, index) {
    ...
    Object.defineProperty(this, 'date', {
      get: () => date.format(calendar.format)
    });
    Object.defineProperty(this, 'object', {
      get: () => date
    });
    Object.defineProperty(this, 'name', {
      get: () => date.toDate().toLocaleString('es-ES', {
        weekday: 'long'
      })
    });
  ...
  *********/
  ...
  function calendarFactory(specs) {
    specs = typeof specs === 'string' ? {
      date: specs
    } : specs;
    let DEFAULT_SPECS = {
  ...
  **************/
  ...
  function Month(year, calendar, base, index, active) {
    ...
    Object.defineProperty(this, 'firstDate', {
      get: () => date.startOf('month').format(calendar.format)
    });
    Object.defineProperty(this, 'lastDate', {
      get: () => date.endOf('month').format(calendar.format)
    });
    const weeks = new Weeks(calendar, base, this);
    Object.defineProperty(this, 'weeks', {
      get: () => weeks
    });
    Object.defineProperty(this, 'name', {
      get: () => date.toDate().toLocaleString(calendar.locale, {
        'month': 'long'
      })
    });
    Object.defineProperty(this, 'shortName', {
  ...
  function Months(year, calendar, base, activeIndex) {
    function getMonthsForLocale(locale = 'ES') {
      ...
      for (let month = 0; month < 12; month++) {
        ...
        months.push(testDate.toLocaleString(locale, {
          'month': 'long'
        }));
      }
  ...
  ************/
  ...
  function Week(calendar, base, month, firstDay, index) {
    ...
    for (let i = defaultStart; i < 7; ++i) {
      ...
      difference++;
      days.set(i, current); //TODO: check validation
  ...
  Week.getDays = function () {
    ...
    const getDayOfWeek = (shortName, locale = config.locale, length = 'short') => new Intl.DateTimeFormat(locale, {
      weekday: length
    }).format(days[shortName]);
  ...
  *************/
  ...
  function Weeks(calendar, base, month) {
    ...
    let configured; // the number of the day of the week that the month start
